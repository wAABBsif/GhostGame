...
component_mask entity_get_component_mask(const entity_id index)
{
	return s_entities[index].components;
}

bool entity_has_component(const entity_id index, const component_type component)
{
	return s_entities[index].components & COMPONENT_MASK(component);
}

void entity_enable_component(const entity_id index, const component_type type)
{
...
void *entity_add_component(const entity_id index, const component_type type)
{
